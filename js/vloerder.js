...
function getCards() {
  ...
  titlebarTitle.textContent = data[lang][0][2][1][0][0];
    for (let i = 0; i < data[lang][0][2][1][0][2].length; i++) {
        ...
        a_sUwXk.href = `${data[lang][0][2][1][0][2][i][0].replace(/ /g, '-').toLowerCase()}.html`;
        ...
        a_FZoyA.href = `${data[lang][0][2][1][0][2][i][0].replace(/ /g, '-').toLowerCase()}.html`;
        ...
        a_piRos.href = `${data[lang][0][2][1][0][2][i][0].replace(/ /g, '-').toLowerCase()}.html`;
